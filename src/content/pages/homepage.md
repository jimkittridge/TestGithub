...
logo: /images/Screenshot 2026-03-17 at 10.03.28 PM.png
hero:
...
citySection:
  ...
  subheading: Three markets across the Carolinas. Each with suites built for real operators.
useCases:
  ...
  items:
    ...
    - title: Brewery & Food Production
      ...
      icon: beer
    - title: Creative & Showroom
      description: Studios, workshops, and showrooms with the clear height and access your work demands.
      icon: palette
    - title: Service Businesses
      description: Combined warehouse and office space for service companies that need both.
      icon: briefcase
highlights:
